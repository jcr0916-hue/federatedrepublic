...
const updates = [
  ...
  },
  {
    ...
    href: "constitutional-history.html#s2-16-recurring-incapacity",
  },
  {
    category: "world",
    badge: "The World",
  ...
  },
  {
    ...
    image: "Elin-Thoss-card.webp",
  },
  {
    category: "world",
    badge: "The World",
    title: "The Korda referendum will not proceed",
    blurb: "The Joint Monitor Council says the two certified Korda petitions trigger §15.5.a(1). The corridor referendum stops and the Territory Convention process begins.",
    href: "torenthia-nrs-034.html",
  },
  {
    category: "world",
    badge: "Dispatch",
    title: "The ship was not late",
    blurb: "Calden harbor pilot Neris Vann explains how one broken conveyor motor rearranged a few hundred people's working day — and became a completely different story by lunchtime.",
    href: "torenthia-dispatch-vann.html",
  },
  {
    category: "world",
    badge: "The World",
    title: "Proposal for a trilateral conference on Lake Varda",
    blurb: "Bilateral inquiry to the Sunderland Interim Authority got a response that answered nothing. The Foreign Affairs Directorate now proposes bringing in Caldris and Valedon. Neither government has responded.",
    href: "torenthia-nrs-032.html",
  },
  {
    category: "world",
    badge: "The World",
