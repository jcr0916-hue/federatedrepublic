#!/usr/bin/env node
import {loadWorldRegistries} from '../lib/world-chronology.mjs';
...
try {
  ...
  const {errors,warnings}=checkWorldPublishing(records,{provisions,dossiers,status,registry:loadWorldRegistries()});
