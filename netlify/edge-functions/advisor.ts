...
The LI reviews all State-drawn district maps within 60 days of submission. If a map fails the §3.4.a criteria, the LI publishes specific findings and the State must submit a corrected map within 30 days. If the corrected map still fails, the LI draws a compliant interim map. The LI cannot draw a permanent map — only an interim one pending State compliance.
