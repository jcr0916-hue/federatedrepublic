...
[§9.3.b] Advisory Council Pool — Constitution
The President and PM each nominate one qualified person per year to the Digital Infrastructure Advisory Pool. Each nominee must be confirmed by the Senate within 60 days of nomination by affirmative vote — no deemed-confirmed fallback applies to this position. Senate failure to vote within 60 days is a constitutional compliance failure published to the NRS by the LI. The pool is a public NRS record. Qualifications are defined by statute and certified by the JI at time of nomination. Over a ten-year cycle both executives may each nominate up to ten members, for a maximum pool of twenty confirmed members.

[§9.3.c] Pool Reset
The Digital Infrastructure Advisory Pool resets after each decennial commission cycle. Previously confirmed pool members who did not serve on the commission may be re-nominated by either executive in the new cycle; fresh Senate confirmation under §9.3.b is required and no member carries forward automatically. Members who served on the commission are not eligible for re-nomination to the pool.
...
Advisory Council findings are published directly and jointly to the NRS by all three Inspectorates upon completion of the decennial review. Findings may include assessments of cryptographic integrity, node distribution adequacy, technical standard compliance, and any architectural features that approach or breach constitutional requirements for either system. The Commission Director, both panel chairs, and both executives receive findings simultaneously with NRS publication. The Commission must publish its response within 90 days — accepting, modifying, or declining each recommendation with published reasons. The Advisory Council's mandate ends upon publication; the Council dissolves and the pool resets under §9.3.c.
