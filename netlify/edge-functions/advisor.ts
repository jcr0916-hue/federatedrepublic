...
At Phase 3, all nine seats are filled simultaneously by PM nomination and Senate confirmation under §4.2.d, then assigned to three classes by public lot drawn by the JI. Class A: 4-year initial term. Class B: 8-year initial term. Class C: 12-year initial term. All subsequent terms: 12 years. The lot assignment is published to the NRS before any justice takes the oath. Three seats confirmed every 4 years thereafter.
...
Phase 3 (Days 271-450) is First Elections. The first National Election Day. Supreme Court justices nominated by the PM and confirmed by the Senate under §4.2.d and §4.2.h. Electoral Commission inaugural elections. Phase 3 ends when the first the Legislature is sworn in and the first executives take office — the moment at which the Republic's constitutional design becomes self-sustaining.
