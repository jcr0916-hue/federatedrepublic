...
[§9.3] Digital Infrastructure Technical Integrity
The National Record System and the National Voting System are reviewed decennially by a Digital Infrastructure Technical Commission for compliance with their respective constitutional architectural requirements under §9.1 and §16.3. The Commission has publication authority only — it may not issue binding orders or direct the Digital Infrastructure Commission. Findings are published jointly by all three Inspectorates to the NRS and transmitted to the Commission Director and both panel chairs simultaneously.

[§9.3.a] Digital Infrastructure Technical Commission
The Digital Infrastructure Technical Commission reviews whether the NRS and NVS architectures continue to meet their respective constitutional requirements under §9.1 and §16.3. The Commission has publication authority only — it may not issue binding orders, impose penalties, or direct the Commission Director. Its findings are published jointly by all three Inspectorates to the NRS and cannot be withheld, suppressed, or altered after publication. The Commission convenes every ten years from the date of the first Legislature convening under §19.3.d. Qualifications for pool eligibility, audit methodology and scope, working session parameters, and compensation are established by statute. The Legislature may not adjust the decennial trigger date by statute. If the LI's annual audit under §9.1.e identifies a critical architectural failure — defined as a finding that the NRS or NVS no longer meets its constitutional requirements for tamper-evident operation, distributed custody, ballot secrecy, or public auditability — the LI may declare an emergency review, triggering an extraordinary Commission draw from the current confirmed pool under §9.3.d. An emergency Commission draw does not reset the decennial clock.

[§9.3.b] RSA Technical Pool — Constitution
The President and PM each nominate one qualified person per year to the Digital Infrastructure Technical Pool. Each nominee must be confirmed by the Senate within 60 days of nomination by affirmative vote — no deemed-confirmed fallback applies to this position. Senate failure to vote within 60 days is a constitutional compliance failure published to the NRS by the LI. The pool is a public NRS record. Qualifications are defined by statute and certified by the JI at time of nomination. Over a ten-year cycle both executives may each nominate up to ten members, for a maximum pool of twenty confirmed members.

[§9.3.c] Pool Reset
The Digital Infrastructure Technical Pool resets after each decennial commission cycle. Previously confirmed pool members who did not serve on the commission may be re-nominated by either executive in the new cycle; fresh Senate confirmation under §9.3.b is required and no member carries forward automatically. Members who served on the commission are not eligible for re-nomination to the pool.

[§9.3.d] Commission Draw
...
[§9.3.f] Tri-Inspectorate Oversight
