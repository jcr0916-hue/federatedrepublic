...
PM appoints senior domestic officers from JI-maintained candidate registries. The registry requirement prevents purely political appointments. Senate confirmation provides a further check. PM removal of appointed officers requires published NRS reasons — arbitrary or politically motivated removal is constitutionally visible.

[§2.2.c] PM Fiscal and Budget Authority
The PM's central domestic power. The annual budget originates with the PM and requires House passage. The PM's certification function for military expenditure is the financial check on the President's domain: no military operation runs without PM-certified funds.

[§2.2.d] Legislative Review Period
The PM reviews all enacted legislation. Three options: sign (or remain silent, triggering Deemed Enactment), Fiscal Objection, or Suspensive Veto. The PM's silence enacts a bill — there is no veto by inaction. The Suspensive Veto returns the bill to the Legislature, which may override by 2/3 of both chambers simultaneously.
...
[§2.2.h] Administrative Acting Officer Framework
Where the PM is temporarily unable to exercise authority, the most senior Domestic Affairs Council Officer (SDACO) serves as Caretaker PM. The SDACO's authority is limited to maintaining existing policy and emergency functions. Caretaker status expires when a new PM is confirmed by the House.
...
The President may be removed on two independent tracks. The legislative track requires 2/3 of both chambers simultaneously following Inspectorate-certified findings. The popular track requires a Senate majority referral to a national recall referendum under §2.10.b. Both tracks are governed by this section.
