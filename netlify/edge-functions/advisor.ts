...
States draw their own House district maps following each census, subject to compliance review by the Legislative Inspectorate against the criteria established in §3.4.a. The LI may draw an interim compliant map where a State submission fails repeated review.
