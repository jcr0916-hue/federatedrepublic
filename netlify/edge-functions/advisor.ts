...
Legal Residents hold a Residency Credential allowing them to work, enter contracts, own property, access BNF programs, and participate in local elections where the Legislature authorizes. They hold all Article I rights as Inhabitants. What they lack that citizens hold: federal voting rights and the right to stand for federal office. No child of a Citizen or Legal Resident may be deported, regardless of the child's own documentation status.
...
Any person who files an asylum claim under §1.28 is an Inhabitant of the Republic from the date of filing — immediately entitled to BNF coverage and all Article I protections. Protection-first: the determination process does not happen in a rights-free zone.
...
The National Record System is administered by a technically independent office under LI oversight.
...
[§10.1.b] BNF Adequacy Standard
The BNF basket must be sufficient to meet genuine basic needs — not merely nominally available. The PM's annual budget must fund the BNF at a level the MA certifies as adequate to deliver the constitutional basket to every eligible Inhabitant. A budget that funds the BNF below the MA's certified adequacy level is constitutionally deficient.

[§10.1.b.i] BNF Non-Compliance — EI Certification and Justiciability
Where the MA's annual adequacy certification under §10.1.b finds that the BNF basket is not being delivered at the constitutional standard, the EI immediately publishes a constitutional compliance breach notice to the NRS. The Republic's failure to meet the BNF adequacy standard is simultaneously directly justiciable by any Inhabitant who can demonstrate they are not receiving the basket at the certified level. Courts may order the Republic to restore compliance and may specify remediation timelines. The justiciability of BNF adequacy failures is self-executing — no enabling legislation is required.

[§10.1.b.ii] BNF Non-Compliance — Legislative Response Obligation
Within 90 days of the EI's breach notice under §10.1.b.i, the Legislature must either publish a funded remediation plan specifying how and when BNF adequacy will be restored, or formally dispute the MA's certification before the SC. If the Legislature disputes the MA's certification, the SC resolves the dispute within 30 days; if the SC upholds the certification, the 90-day remediation clock restarts from the SC's ruling. Failure to publish a remediation plan or initiate a formal dispute within 90 days is a further constitutional compliance breach certified by the LI.

[§10.1.b.iii] BNF Non-Compliance — National Endowment Backstop
If 90 days pass after the EI breach notice under §10.1.b.i without a published legislative remediation plan and without a pending SC dispute, the National Endowment board may authorize emergency BNF expenditure under §10.6 to fill the adequacy gap. The PM certifies the expenditure under §2.1.d. Emergency backstop disbursements continue for up to 6 months. If after 6 months the Legislature has still not published a remediation plan, the Endowment board must report to the NRS that the constitutional promise of the BNF is not being honoured through the normal budget process and that the Endowment is bearing the gap. The Endowment backstop does not relieve the Legislature of its constitutional obligation to fund the BNF through the annual budget — it ensures Inhabitants receive the basket while that obligation is enforced.

[§10.1.c] BNF Coverage Scope
The BNF must cover five categories: food security, housing, healthcare, education access, and digital connectivity. The Legislature defines the specific floor within each category by statute. No statute may reduce any category below the level of genuine adequacy — the constitutional floor is real sufficiency, not symbolic provision.

[§10.1.d] BNF Non-Discrimination
Access to BNF benefits may not be conditioned on citizenship, residency status, political affiliation, or any characteristic protected under §1.9. Every Inhabitant receives equal access. The Legislature may not create tiered access based on contribution history or prior benefit receipt — the BNF is a floor, not an insurance program.

[§10.1.e] BNF Administration
The PM administers the BNF through the Domestic Affairs Council. Administration must meet the constitutional adequacy standard — delivery mechanisms must actually reach Inhabitants, not merely be nominally available. The LI audits BNF delivery annually.

[§10.1.f] Severe Revenue Contraction Protocol
Where the MA certifies a severe revenue contraction, the BNF funding floor remains in effect and the National Endowment reserve fund supplements the 5% reserve to ensure BNF continuity. The MA certification triggers automatic activation of the Endowment — no legislative action required. The BNF is recession-proof.

[§10.1.g] BNF and Emergency Declarations
No domestic emergency may reduce, suspend, or otherwise diminish BNF benefits. The BNF is explicitly excluded from emergency powers. A PM who attempts to redirect BNF funds during an emergency has committed a constitutional breach reportable by the EI.
...
The foundational category for non-State jurisdictions within the Republic. A Territory operates under a Territorial Compact, has federal protections under Article I, receives BNF benefits, and may begin the Statehood pathway under §13.2. Territories hold House seats proportional to their population under §3.1.a and participate in the House as full voting members. Territories do not hold Senate seats; Senate representation is reserved for States.
...
Electoral Commission members must meet three independently verified requirements: at least 15 years of professional expertise in elections, technology, or public administration; no current or recent partisan affiliation; and passage of the Constitutional Logic Test. The qualifications are substantive — the EC requires genuine expertise.

[§16.2.a] Electoral Commission Removal
Electoral Commission members may be removed for cause only. No no-cause removal is available for EC members. For-cause removal requires: a JI-documented finding transmitted to a State Designee Panel under §8.9.f; a Panel determination that stated grounds are substantiated; a 14-day SC appeal window from publication of the Panel finding; and a 2/3 vote of both chambers simultaneously. Where the Panel finding is substantiated, the EC member is suspended from all duties pending the legislative vote and any SC review. On legislative acquittal following a substantiated Panel finding, the member returns to full duties immediately. Any removal vote scheduled within 180 days of a major national election is automatically suspended pending SC review within 48 hours; the proximity restriction applies to the removal vote, not to Panel-triggered suspension of duties.
...
[§16.6] Electoral Commission Technical Deadlock
...
Existing government officials serve as caretakers under §19.4. The joint Inspectorate panel assumes oversight. The NRS begins recording all government acts. Priority functions: Basic Needs Floor delivery continuity, public safety, and essential services. No new permanent legislation.

[§19.3.c] Phase 2 — Institutional Construction (Days 91–270)
Phase 2 (Days 91–270) is Institutional Construction. Statehood Audits are conducted for all entering territories. Inspectorates are formally constituted. The Candidate Register for MA board members and the RSA Director is assembled. Electoral Commission is certified as operational. The National Voting System is fully deployed for citizen registration. Phase 2 ends at Day 270.
