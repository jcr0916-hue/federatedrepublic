...
Cryptographic keys are private property. No court or agency may compel their disclosure.
...
The President negotiates and concludes trade agreements; PM written concurrence is required where the agreement materially affects the domestic economy. National treatment obligations within Republic territory require PM concurrence, as they directly govern how domestic industry is regulated. Where PM concurrence is withheld, domestic provisions may be transmitted to the House Speaker as ordinary legislation. Ratification requires a 2/3 Senate majority under §3.2.e.
...
Civil servants must refuse and report any order that lacks required PM fund certification, violates any Article I right, or has not been recorded on the National Record System. A civil servant who refuses an unconstitutional order may not be dismissed, demoted, or penalized for that refusal. The EI reports any attempt to penalize a refusing civil servant to the NRS.
...
The 8-year maximum — no PM may serve more than 8 consecutive years. After 8 years, the PM must stand down even if the House would re-elect them. The 8-year maximum and the constructive vote operate independently — a PM reaching 8 years is replaced through a House election of a successor.
...
The Senate confirms all judicial appointments by a supermajority defined by statute (not less than 55%, not more than 67% of full Senate membership). Failure to vote within the confirmation period triggers Deemed Confirmation. The supermajority requirement ensures judicial appointments require cross-party support.
...
When a House district seat falls vacant mid-term, the Electoral Commission administers a special election within 90 days. The replacement serves only the remainder of the original term. If fewer than 90 days remain in the term, the vacancy is not filled.
...
The LI publishes a constitutional analysis of any bill that appears to conflict with a constitutional provision, before the bill reaches a final vote. Advisory, not blocking — but creates a permanent NRS record that any member voting for the bill voted with full knowledge of the constitutional concern.
...
The PM nominates inferior court judges within 90 days of a vacancy. The Senate confirms by a supermajority of 55–67% of full seated membership, as the Legislature defines by statute. Before the confirmation vote, the PM submits the nominee's disclosure record to the EI; the EI publishes its review before the vote. Where the PM fails to nominate within 90 days, the Senate may nominate directly. The confirmation period is prorated where nomination occurs late. No vacancy may remain unfilled beyond 180 days; Deemed Confirmation applies at that ceiling if no vote has been held.
...
At Phase 3, all nine seats are filled simultaneously, then assigned to three classes by public lot drawn by the JI. Class A: 4-year initial term. Class B: 8-year initial term. Class C: 12-year initial term. All subsequent terms: 12 years. The lot assignment is published to the NRS before any justice takes the oath. Three seats elected every 4 years thereafter.
...
NRS findings published by the LI, EI, or JI are admissible as authoritative factual evidence in judicial proceedings. Courts must address any inconsistency between their factual findings and a prior Inspectorate finding in written decisions. Inspectorate findings are not judicial determinations — courts retain full authority to reach different factual conclusions — but must explain why.
...
[§5.1.g] Accelerated Naturalization — Long-Term Pre-Ratification Residents
Any person who resided continuously in the Republic's territory for five or more years immediately before Day Zero but did not hold predecessor voting rights — including persons disenfranchised by laws subsequently nullified under §19.2 — may apply for citizenship through an accelerated process the Legislature must establish within one year of Phase 4. The process must waive the CLT requirement and must be completed within 90 days of application.
...
[§7.2.c.i] State Candidate Pools
Each State maintains a standing Regional Boundary Pool for each redistricting cycle. Any person may be placed into a State's Pool through the State's own constitutional or statutory process, provided they meet three eligibility requirements at the time of entry: at least five continuous years of Republic citizenship; at least five continuous years of residency in the State whose Pool they are entering; and no current elected office. The LI certifies eligibility before entry — ministerially, not selectively. States determine through their own process how candidates are nominated from among those eligible. An entrant who takes elected office after entering the Pool is ineligible to be drawn for so long as they hold that office; if drawn while in elected office, the JI draws a replacement from the same State's eligible Pool. The LI maintains each State's Pool as a public record on the NRS. States need only submit names to the LI for certification and pay their drawn representative during commission service.

[§7.2.c.ii] Annual Addition Cap
...
[§7.2.f] Run-off
If two candidates are within 0.5 percentage points of each other on the final combined score as calculated under §7.2.b, a head-to-head national RCV runoff is conducted between those two candidates.
...
The JI maintains the standing registry from which SC candidates are drawn. Any citizen meeting the eligibility criteria (15+ years legal practice or 10+ years judicial service, no current government position, no disqualifying financial interest) may apply. Applications reviewed within 21 days. Registry inclusion does not expire. Publicly accessible on the NRS at all times.
...
[§13.2.a] Fiscal Integrity
The LI audits the territory's government finances for basic fiscal sustainability, absence of structural insolvency that would require federal bailout, and basic public financial management standards. The audit checks whether the territory can function as a financially independent State — not whether its fiscal policy is optimal.

[§13.2.b] Legal Sync
The JI audits the territory's legal system for compliance with every Article I right. Statehood is not granted to jurisdictions that are constitutionally non-compliant — a territory that applies Article I rights inconsistently cannot become a State while those violations persist.

[§13.2.c] The Provisional Membership Period
Upon passing the Statehood Audit, the territory enters a Provisional Membership Period of between 365 and 900 days (Legislature defines by statute). Clean completion results in automatic Statehood — no further action required.
...
The Director and panel administrators may be removed for cause only. For-cause removal requires: a JI-documented finding transmitted to a State Designee Panel under §8.9.f; a Panel determination that stated grounds are substantiated; a 14-day SC appeal window from publication of the Panel finding; and a 2/3 vote of both chambers simultaneously. A Director or administrator subject to active removal proceedings is suspended from duties pending the legislative vote. Any removal vote scheduled within 180 days of a major national election is automatically suspended pending SC review within 48 hours.
...
No person or institution — including Electoral Commission members — may identify how any individual citizen voted. Ballot secrecy is constitutionally absolute. The NVS must make it technically impossible to link any vote to any voter, even in post-election audits.
...
Before each federal election window opens, the Electoral Commission delivers to every eligible citizen: the list of federal races on their ballot, the NVS access procedures, and the certification timeline. Delivery must reach every eligible citizen through at least two distinct channels.
...
Phase 0 is the pre-ratification preparation period. The interim Electoral Commission is constituted, the National Voting System is certified operational, and the joint Inspectorate panel is formed — all before any ratification vote occurs.
