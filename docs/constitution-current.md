...
(1) Full succession activates on the Legat Consul's death, resignation, or removal, including removal on grounds of demonstrated permanent incapacity under §2.13. The Senate Speaker holds the office of Legat Consul from the moment the triggering event occurs — no active assumption, oath, publication, or other implementing act is required. The transfer is instantaneous and self-executing by constitutional operation and must be recorded to the NRS as soon as possible.
