...
**Status: John is sitting on this. Not written into constitution_data.json. Nothing built,
synced, or pushed. This file exists so the full reasoning survives until he picks it back up —
possibly in a session that won't have this conversation's context.**
